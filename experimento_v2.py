...
def evaluacion_generacion(genes, generacion):
    # pesos de neuronas y tamano de la poblacion
...
# parametros del algoritmo ## llego a 60 en generacion 70
n_gen = 300 # numero de generaciones
...
for i in range(n_gen):
    ...
    hijos, fit_hijos = reemplazo_generacional(best_genes, hijos, best_fitness, fit_hijos, elitismo=6)
...
final_info.to_csv(f'OUTPUTS2/exp_{seed}seed_{n_ind}pob_{rf}r_{p_cross}c_{p_mut}m_{elitismo}e.csv', index=False)